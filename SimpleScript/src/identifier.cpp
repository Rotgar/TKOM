...
Identifier::Identifier(Identifier parent, int childPosition) {
  	string childPropertyName = to_string(childPosition);
...
string Identifier::getLastId() {
    return this->propertiesNames.back();
}
